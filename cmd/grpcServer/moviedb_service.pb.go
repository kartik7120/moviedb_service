...
func (x *Movie) GetScreenWidePosterUrl() string {
	if x != nil {
		return x.ScreenWidePosterUrl
	}
	return ""
}
...
func (x *CreateTicketResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *CreateTicketResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *GetMovieTimeSlotDetailsRequest) Reset() {
	*x = GetMovieTimeSlotDetailsRequest{}
	mi := &file_moviedb_service_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMovieTimeSlotDetailsRequest) Descriptor() ([]byte, []int) {
	return file_moviedb_service_proto_rawDescGZIP(), []int{50}
}
...
func (x *GetTicketDetailsRequest) Reset() {
	*x = GetTicketDetailsRequest{}
	mi := &file_moviedb_service_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetTicketDetailsRequest) Descriptor() ([]byte, []int) {
	return file_moviedb_service_proto_rawDescGZIP(), []int{51}
}

func (x *GetTicketDetailsRequest) GetTicketID() string {
	if x != nil {
		return x.TicketID
	}
	return ""
...
type GetTicketDetailsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ImageURL      string                 `protobuf:"bytes,1,opt,name=imageURL,proto3" json:"imageURL,omitempty"` // Poster image URL
	MovieTitle    string                 `protobuf:"bytes,2,opt,name=movieTitle,proto3" json:"movieTitle,omitempty"`
	...
	SeatNumbers   []string               `protobuf:"bytes,5,rep,name=seatNumbers,proto3" json:"seatNumbers,omitempty"`
	BookingID     string                 `protobuf:"bytes,6,opt,name=bookingID,proto3" json:"bookingID,omitempty"`
	QrCodeURL     string                 `protobuf:"bytes,7,opt,name=qrCodeURL,proto3" json:"qrCodeURL,omitempty"` // QR code image URL
	Language      string                 `protobuf:"bytes,8,opt,name=language,proto3" json:"language,omitempty"`
	Format        string                 `protobuf:"bytes,9,opt,name=format,proto3" json:"format,omitempty"` // e.g., "2D", "3D", "IMAX"
	Date          string                 `protobuf:"bytes,10,opt,name=date,proto3" json:"date,omitempty"`    // e.g., "2023-10-15"
	VenueName     string                 `protobuf:"bytes,11,opt,name=venueName,proto3" json:"venueName,omitempty"`
	ScreenNumber  string                 `protobuf:"bytes,12,opt,name=screenNumber,proto3" json:"screenNumber,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetTicketDetailsResponse) Reset() {
	*x = GetTicketDetailsResponse{}
	mi := &file_moviedb_service_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetTicketDetailsResponse) Descriptor() ([]byte, []int) {
	return file_moviedb_service_proto_rawDescGZIP(), []int{52}
}

func (x *GetTicketDetailsResponse) GetImageURL() string {
	if x != nil {
		return x.ImageURL
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetMovieTitle() string {
	if x != nil {
		return x.MovieTitle
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetCinemaName() string {
	if x != nil {
		return x.CinemaName
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetShowTime() string {
	if x != nil {
		return x.ShowTime
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetSeatNumbers() []string {
	if x != nil {
...
func (x *GetTicketDetailsResponse) GetBookingID() string {
	if x != nil {
		return x.BookingID
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetQrCodeURL() string {
	if x != nil {
		return x.QrCodeURL
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetLanguage() string {
	if x != nil {
		return x.Language
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetFormat() string {
	if x != nil {
		return x.Format
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetVenueName() string {
	if x != nil {
		return x.VenueName
	}
	return ""
...
func (x *GetTicketDetailsResponse) GetScreenNumber() string {
	if x != nil {
		return x.ScreenNumber
	}
	return ""
...
const file_moviedb_service_proto_rawDesc = "" +
	...
	"\bTicketID\x18\x04 \x01(\tR\bTicketID\"E\n" +
	"\x15CreateRequestResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x05R\x06status\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\"M\n" +
	"\x1eGetMovieTimeSlotDetailsRequest\x12+\n" +
	"\x12movie_time_slot_id\x18\x01 \x01(\x05R\x0fmovieTimeSlotId\"5\n" +
	"\x17GetTicketDetailsRequest\x12\x1a\n" +
	"\bticketID\x18\x01 \x01(\tR\bticketID\"\xfa\x02\n" +
	"\x18GetTicketDetailsResponse\x12\x1a\n" +
	"\bimageURL\x18\x01 \x01(\tR\bimageURL\x12\x1e\n" +
	"\n" +
	"movieTitle\x18\x02 \x01(\tR\n" +
	"movieTitle\x12\x1e\n" +
	"\n" +
	"cinemaName\x18\x03 \x01(\tR\n" +
	"cinemaName\x12\x1a\n" +
	"\bshowTime\x18\x04 \x01(\tR\bshowTime\x12 \n" +
	"\vseatNumbers\x18\x05 \x03(\tR\vseatNumbers\x12\x1c\n" +
	"\tbookingID\x18\x06 \x01(\tR\tbookingID\x12\x1c\n" +
	"\tqrCodeURL\x18\a \x01(\tR\tqrCodeURL\x12\x1a\n" +
	"\blanguage\x18\b \x01(\tR\blanguage\x12\x16\n" +
	"\x06format\x18\t \x01(\tR\x06format\x12\x12\n" +
	"\x04date\x18\n" +
	" \x01(\tR\x04date\x12\x1c\n" +
	"\tvenueName\x18\v \x01(\tR\tvenueName\x12\"\n" +
	"\fscreenNumber\x18\f \x01(\tR\fscreenNumber*C\n" +
	"\bSeatType\x12\t\n" +
	...
	"\fCreateTicket\x12$.moviedb_service.CreateTicketRequest\x1a%.moviedb_service.CreateTicketResponse\x12c\n" +
	"\x10GetMovieTimeSlot\x12/.moviedb_service.GetMovieTimeSlotDetailsRequest\x1a\x1e.moviedb_service.MovieTimeSlot\x12g\n" +
	"\x10GetTicketDetails\x12(.moviedb_service.GetTicketDetailsRequest\x1a).moviedb_service.GetTicketDetailsResponseBFZDgithub.com/kartik7120/booking_moviedb_service/cmd/grpcServer;moviedbb\x06proto3"
...
var file_moviedb_service_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_moviedb_service_proto_goTypes = []any{
	...
	(*CreateTicketResponse)(nil),                    // 53: moviedb_service.CreateTicketResponse
	(*CreateRequestResponse)(nil),                   // 54: moviedb_service.CreateRequestResponse
	(*GetMovieTimeSlotDetailsRequest)(nil),          // 55: moviedb_service.GetMovieTimeSlotDetailsRequest
	(*GetTicketDetailsRequest)(nil),                 // 56: moviedb_service.GetTicketDetailsRequest
	(*GetTicketDetailsResponse)(nil),                // 57: moviedb_service.GetTicketDetailsResponse
...
var file_moviedb_service_proto_depIdxs = []int32{
	...
	58, // 35: moviedb_service.MovieDBService.GetAllMovies:input_type -> google.protobuf.Empty
	...
	58, // 40: moviedb_service.MovieDBService.GetAllVenues:input_type -> google.protobuf.Empty
	...
	55, // 65: moviedb_service.MovieDBService.GetMovieTimeSlot:input_type -> moviedb_service.GetMovieTimeSlotDetailsRequest
	56, // 66: moviedb_service.MovieDBService.GetTicketDetails:input_type -> moviedb_service.GetTicketDetailsRequest
	14, // 67: moviedb_service.MovieDBService.AddMovie:output_type -> moviedb_service.MovieResponse
	14, // 68: moviedb_service.MovieDBService.GetMovie:output_type -> moviedb_service.MovieResponse
	15, // 69: moviedb_service.MovieDBService.GetAllMovies:output_type -> moviedb_service.MovieListResponse
	14, // 70: moviedb_service.MovieDBService.UpdateMovie:output_type -> moviedb_service.MovieResponse
	14, // 71: moviedb_service.MovieDBService.DeleteMovie:output_type -> moviedb_service.MovieResponse
	16, // 72: moviedb_service.MovieDBService.AddVenue:output_type -> moviedb_service.VenueResponse
	16, // 73: moviedb_service.MovieDBService.GetVenue:output_type -> moviedb_service.VenueResponse
	15, // 74: moviedb_service.MovieDBService.GetAllVenues:output_type -> moviedb_service.MovieListResponse
	16, // 75: moviedb_service.MovieDBService.UpdateVenue:output_type -> moviedb_service.VenueResponse
	14, // 76: moviedb_service.MovieDBService.DeleteVenue:output_type -> moviedb_service.MovieResponse
	18, // 77: moviedb_service.MovieDBService.GetUpcomingMovies:output_type -> moviedb_service.GetUpcomingMovieResponse
	18, // 78: moviedb_service.MovieDBService.GetNowPlayingMovies:output_type -> moviedb_service.GetUpcomingMovieResponse
	22, // 79: moviedb_service.MovieDBService.AddReview:output_type -> moviedb_service.ReviewResponse
	22, // 80: moviedb_service.MovieDBService.GetReview:output_type -> moviedb_service.ReviewResponse
	22, // 81: moviedb_service.MovieDBService.UpdateReview:output_type -> moviedb_service.ReviewResponse
	22, // 82: moviedb_service.MovieDBService.DeleteReview:output_type -> moviedb_service.ReviewResponse
	25, // 83: moviedb_service.MovieDBService.GetAllMovieReviews:output_type -> moviedb_service.ReviewListResponse
	28, // 84: moviedb_service.MovieDBService.GetMovieTimeSlots:output_type -> moviedb_service.GetMovieTimeSlotResponse
	29, // 85: moviedb_service.MovieDBService.AddMovieTimeSlot:output_type -> moviedb_service.MovieTimeSlotResponse
	30, // 86: moviedb_service.MovieDBService.UpdateMovieTimeSlot:output_type -> moviedb_service.MovieTimeSlotUpdateResponse
	29, // 87: moviedb_service.MovieDBService.DeleteMovieTimeSlot:output_type -> moviedb_service.MovieTimeSlotResponse
	7,  // 88: moviedb_service.MovieDBService.AddSeatMatrix:output_type -> moviedb_service.AddSeatMatrixResponse
	42, // 89: moviedb_service.MovieDBService.AddSingleSeatMatrix:output_type -> moviedb_service.AddSingleSeatMatrixResponse
	34, // 90: moviedb_service.MovieDBService.GetSeatMatrix:output_type -> moviedb_service.GetSeatMatrixResponse
	36, // 91: moviedb_service.MovieDBService.UpdateSeatMatrix:output_type -> moviedb_service.UpdateSeatMatrixResponse
	38, // 92: moviedb_service.MovieDBService.DeleteSeatMatrix:output_type -> moviedb_service.DeleteSeatMatrixResponse
	40, // 93: moviedb_service.MovieDBService.DeleteEntireSeatMatrix:output_type -> moviedb_service.DeleteEntireSeatMatrixResponse
	45, // 94: moviedb_service.MovieDBService.BookSeats:output_type -> moviedb_service.BookSeatsResponse
	47, // 95: moviedb_service.MovieDBService.GetBookedSeats:output_type -> moviedb_service.GetBookedSeatsResponse
	51, // 96: moviedb_service.MovieDBService.IsValidToCommitSeatsForBooking:output_type -> moviedb_service.IsValidToCommitSeatsForBooking_Response
	49, // 97: moviedb_service.MovieDBService.LockBookedSeats:output_type -> moviedb_service.GetBookedSeatsDetailsResponse
	53, // 98: moviedb_service.MovieDBService.CreateTicket:output_type -> moviedb_service.CreateTicketResponse
	9,  // 99: moviedb_service.MovieDBService.GetMovieTimeSlot:output_type -> moviedb_service.MovieTimeSlot
	57, // 100: moviedb_service.MovieDBService.GetTicketDetails:output_type -> moviedb_service.GetTicketDetailsResponse
