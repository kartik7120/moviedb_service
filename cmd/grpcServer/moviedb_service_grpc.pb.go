...
func (c *movieDBServiceClient) GetAllMovies(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MovieListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *movieDBServiceClient) GetAllVenues(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MovieListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MovieListResponse)
...
func (UnimplementedMovieDBServiceServer) GetAllMovies(context.Context, *emptypb.Empty) (*MovieListResponse, error) {
...
func _MovieDBService_GetAllMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieDBServiceServer).GetAllMovies(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MovieDBService_GetAllVenues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieDBServiceServer).GetAllVenues(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
