...
const (
	...
	MovieDBService_GetTicketDetails_FullMethodName               = "/moviedb_service.MovieDBService/GetTicketDetails"
)
...
type MovieDBServiceClient interface {
	...
	GetTicketDetails(ctx context.Context, in *GetTicketDetailsRequest, opts ...grpc.CallOption) (*GetTicketDetailsResponse, error)
}
...
func (c *movieDBServiceClient) CreateTicket(ctx context.Context, in *CreateTicketRequest, opts ...grpc.CallOption) (*CreateTicketResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *movieDBServiceClient) GetTicketDetails(ctx context.Context, in *GetTicketDetailsRequest, opts ...grpc.CallOption) (*GetTicketDetailsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTicketDetailsResponse)
	err := c.cc.Invoke(ctx, MovieDBService_GetTicketDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieDBServiceServer interface {
	...
	GetTicketDetails(context.Context, *GetTicketDetailsRequest) (*GetTicketDetailsResponse, error)
...
func (UnimplementedMovieDBServiceServer) CreateTicket(context.Context, *CreateTicketRequest) (*CreateTicketResponse, error) {
...
func (UnimplementedMovieDBServiceServer) GetTicketDetails(context.Context, *GetTicketDetailsRequest) (*GetTicketDetailsResponse, error) {
...
func _MovieDBService_GetTicketDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTicketDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieDBServiceServer).GetTicketDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieDBService_GetTicketDetails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieDBServiceServer).GetTicketDetails(ctx, req.(*GetTicketDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MovieDBService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MovieDBService_GetTicketDetails_Handler,
		},
	},
